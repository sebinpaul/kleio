...
export default function TwitterDashboard() {
  ...
  const fetchTwitterData = async () => {
    try {
      ...
      // Fetch Twitter keywords
      const keywordsResponse = await fetch('/api/keywords', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ platform: Platform.TWITTER })
      });
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">Twitter Monitoring</h1>
            <p className="text-muted-foreground">
              Monitor Twitter mentions and track your keywords
            </p>
          </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>Twitter Keywords</CardTitle>
            <CardDescription>
              Manage your Twitter monitoring keywords
            </CardDescription>
          </CardHeader>
          <CardContent>
            <KeywordList
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Latest Twitter mentions of your keywords
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-xs text-muted-foreground">
                        ...
                        <span>•</span>
                        <span>Replies: {mention.platform_comments_count || 0}</span>
                      </div>
                    </div>
              ...
              {mentions.length === 0 && (
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>No Twitter mentions found yet</p>
